...
#pragma region BindNormalMapData
	if (m_enableNormalMap) {
		...
		glVertexAttribPointer(
			m_shader->GetAttrTangents(),			// The attribute we want to configure
			3,										// size (3 components)
			GL_FLOAT,								// type
			GL_FALSE,								// normalized?
		...
		glVertexAttribPointer(
			m_shader->GetAttrBitangents(),			// The attribute we want to configure
			3,										// size (3 components)
			GL_FLOAT,								// type
			GL_FALSE,								// normalized?
			stride * sizeof(float),					// stride floats per vertex definition
...
#pragma region BindInstancingData
	if (m_enableInstancing) {
		...
		glVertexAttribPointer(
			m_shader->GetAttrInstanceMatrix(),		// The attribute we want to configure
			4,										// size (4 components)
			GL_FLOAT,								// type
			GL_FALSE,								// normalized?
		...
		glVertexAttribPointer(
			m_shader->GetAttrInstanceMatrix() + 1,	// The attribute we want to configure
			4,										// size (4 components)
			GL_FLOAT,								// type
			GL_FALSE,								// normalized?
			sizeof(glm::mat4),						// stride
		...
		glVertexAttribPointer(
			m_shader->GetAttrInstanceMatrix() + 2,	// The attribute we want to configure
			4,										// size (4 components)
			GL_FLOAT,								// type
			GL_FALSE,								// normalized?
			sizeof(glm::mat4),						// stride
		...
		glVertexAttribPointer(
			m_shader->GetAttrInstanceMatrix() + 3,	// The attribute we want to configure
			4,										// size (4 components)
			GL_FLOAT,								// type
			GL_FALSE,								// normalized?
			sizeof(glm::mat4),						// stride
